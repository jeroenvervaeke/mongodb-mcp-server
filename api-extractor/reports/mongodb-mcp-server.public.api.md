...
export class ApiClient {
    ...
    // (undocumented)
    updateCluster(projectId: string, clusterName: string, body: Partial<components["schemas"]["ClusterDescription20240805"]>): Promise<components["schemas"]["ClusterDescription20240805"]>;
    // (undocumented)
